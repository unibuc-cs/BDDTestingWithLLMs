...
Feature: Simulate a basic car
  ...
  Scenario: Verify handling on dry asphalt and downhill
    Given the car in on dry road
    And the inclination of the road is downhill
      And that the car's heading is 0 deg
    When I turn left at a yaw rate of 20 deg/sec for 18 seconds
    Then the car's heading should be 340 deg
